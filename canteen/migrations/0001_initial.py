# Generated by Django 3.1.5 on 2021-04-03 17:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='foods', verbose_name='菜品图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asked_meals', models.ManyToManyField(blank=True, to='canteen.FoodForMeal', verbose_name='已点的餐')),
